...
//*************************************Create a new Team Online***************************************
    ...
    public void createNewTeam() throws Exception {
    	...
    	testLog.log(Status.INFO, "THE END");
    	// driver.close();driver.quit();
    }
//*************************************Checking the existence of the team***************************************
    @Test(priority = 1, description="Check New team creation")
   public void checkNewTeam() throws Exception {
    	...
    	testLog.log(Status.INFO, "The team is on the list.");
    	testLog.pass("The team "+newTeamName+teamNumber+" is on the list.");
    	Thread.sleep(2000);
    }
    //******************************************FLOW TAB***********************************************
    @Test(priority=2, description = "Add Flow tab")
    public void addNewFlowTab() throws Exception, IOException {
    	String element = "Flow";
    	loginAsAmdocsUser("Teams");
    	TeamsChannelPage teamsPage = new TeamsChannelPage(driver);
    	teamsPage.clickTeamsTab();
...
//*******************************************Add A New Tab************************************************
    @Test(priority = 2, description="Add new tab")
    public void addNewTabWeb() throws Exception, IOException {
    	...
    	teamsPage.chooseElementFromAddATab(element);
    	Thread.sleep(5000);
        teamsPage.specifyWebSiteNameAndURL("TestName_"+teamNumber, "https://mvnrepository.com/");
    	Thread.sleep(3000);
    	teamsPage.clickTeamsTab();
...
//*********************************************************************************************************
//************************************ To Do main functionality checking **********************************
//*********************************************************************************************************    
    @Test(priority = 4)
...
//********************************************************************************************************
    ...
    public void formsMainFunctionality() throws InterruptedException, IOException {
    	testLog = extent.createTest(getClass().getName());
    	testLog.log(Status.INFO, "Start Forms app");
    	...
    	Thread.sleep(5000);
    	Assert.assertEquals(formsPage.searchFormByName(myParam), false); 
